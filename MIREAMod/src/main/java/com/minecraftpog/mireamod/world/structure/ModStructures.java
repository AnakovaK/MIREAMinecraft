package com.minecraftpog.mireamod.world.structure;
...
public class ModStructures {
     ...
     */
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, MIREAMod.MODID);
