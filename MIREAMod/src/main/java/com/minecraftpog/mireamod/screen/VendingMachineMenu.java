package com.minecraftpog.mireamod.screen;
...
import com.minecraftpog.mireamod.screen.slot.ModResultSlot;
...
public class VendingMachineMenu extends AbstractContainerMenu {
    ...
    public VendingMachineMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.VENDING_MACHINE_MENU.get(), pContainerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.VENDING_MACHINE_BLOCK.get());
    }
